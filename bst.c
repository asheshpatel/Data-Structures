...
#if 1
/***********************************************************
 * function to build a Binary Search Tree (BST) by adding
 * numbers in this specific order
 ...
 * nameTestFunction - the name of the function that has
 * been tested message
 ***********************************************************/
...
/***********************************************************
 * function to test that the BST contains the elements 
 * that we added to it
 ***********************************************************/
